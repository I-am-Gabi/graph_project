...
def _chk_size(a,b):
    ...
    (na, nb) = (a.size, b.size)
    if na != nb:
        raise ValueError("The size of the inputs array should match!"
                         " (%s <> %s)" % (na, nb))
    return (a, b, na)
...
def argstoarray(*args):
    ...
    if len(args) == 1 and not isinstance(args[0], ndarray):
        ...
        if output.ndim != 2:
            raise ValueError("The inputs should be 2D")
    else:
        n = len(args)
...
def find_repeats(arr):
    ...
    The inputs is cast to float64. Masked values are discarded.
...
def spearmanr(x, y, use_ties=True):
    ...
    df = n-2
    if df < 0:
        raise ValueError("The inputs must have at least 3 entries!")
...
def linregress(x, y=None):
    ...
    if y is None:
        ...
        if x.shape[0] == 2:
            ...
            msg = ("If only `x` is given as inputs, it has to be of shape "
...
def trima(a, limits=None, inclusive=(True,True)):
    ...
    Returns a masked version of the inputs array.
    ...
    limits : {None, tuple}, optional
        ...
        Values of the inputs array lower (greater) than the lower (upper) limit
...
trimdoc = """
    ...
    limits : {None, tuple}, optional
        ...
        Values of the inputs array lower (greater) than the lower (upper) limit are
        masked.
...
def trimboth(data, proportiontocut=0.2, inclusive=(True,True), axis=None):
    ...
    axis : int, optional
        ...
        If None, the inputs array is first flattened.
...
def trimtail(data, proportiontocut=0.2, tail='left', inclusive=(True,True),
    ...
    axis : int, optional
        Axis along which to perform the trimming.
        If None, the inputs array is first flattened.  Default is None.
...
def trimmed_stde(a, limits=(0.1,0.1), inclusive=(1,1), axis=None):
    ...
    def _trimmed_stde_1D(a, low_limit, up_limit, low_inclusive, up_inclusive):
        "Returns the standard error of the trimmed mean for a 1D inputs data."
        n = a.count()
        idx = a.argsort()
        if low_limit:
            if low_inclusive:
...
def _mask_to_limits(a, limits, inclusive):
    ...
    inputs array less than the lower limit or greater than the upper limit
...
def tmean(a, limits=None, inclusive=(True, True), axis=None):
    ...
    limits : None or (lower limit, upper limit), optional
        Values in the inputs array less than the lower limit or greater than the
...
def tmin(a, lowerlimit=None, axis=0, inclusive=True):
    ...
    lowerlimit : None or float, optional
        Values in the inputs array less than the given limit will be ignored.
...
def tmax(a, upperlimit=None, axis=0, inclusive=True):
    ...
    upperlimit : None or float, optional
        Values in the inputs array greater than the given limit will be ignored.
...
def winsorize(a, limits=None, inclusive=(True, True), inplace=False,
              axis=None):
    """Returns a Winsorized version of the inputs array.
...
def moment(a, moment=1, axis=0):
    ...
    if moment == 1:
        ...
        if shape:
            ...
            # the inputs was 1D, so return a scalar instead of a rank-0 array
...
def kurtosistest(a, axis=0):
    ...
    if np.ma.isMaskedArray(denom):
        # For multi-dimensional array inputs
...
def mquantiles(a, prob=list([.25,.5,.75]), alphap=.4, betap=.4, axis=None,
    ...
    axis : int, optional
        Axis along which to perform the trimming.
        If None (default), the inputs array is first flattened.
...
def obrientransform(*args):
    """
    Computes a transform on inputs data (any number of columns).  Used to
...
def sem(a, axis=0, ddof=1):
    """
    Calculates the standard error of the mean of the inputs array.
    ...
    -------
    s : ndarray or float
        The standard error of the mean in the sample(s), along the inputs axis.
...
def friedmanchisquare(*args):
    ...
    Each inputs is considered a given group. Ideally, the number of treatments
