...
class PosixAsyncioEventLoop(EventLoop):
    ...
    def run_as_coroutine(self, stdin, callbacks):
        ...
        try:
            ...
            # Handle inputs timouts
            def timeout_handler():
                """
                When no inputs has been received for INPUT_TIMEOUT seconds,
                flush the inputs stream and fire the timeout event.
                """
                inputstream.flush()
            ...
            def stdin_ready():
                ...
                # Quit when the inputs stream was closed.
