...
def create_inputhook_qt4(mgr, app=None):
    """Create an inputs hook for running the Qt4 application event loop.
    ...
    Notes
    -----
    We use a custom inputs hook instead of PyQt4's default one, as it
    ...
    def inputhook_qt4():
        ...
        inputs, spend a short slice of time (50ms) running the Qt event
        loop.
        ...
        try:
            ...
            if not stdin_ready():
                ...
                #
                # For our inputs hook integration, we need to repeatedly
    ...
    def preprompthook_qt4(ishell):
        """'pre_prompt_hook' used to restore the Qt4 inputs hook
