...
def _gen_alignment_data(dtype=float32, type='binary', max_size=24):
    ...
    type : string
        'unary': create data for unary operations, creates one inputs
                 and output array
        'binary': create data for unary operations, creates two inputs
                 and output array
    max_size : integer
    ...
    Returns
    -------
    if type is 'unary' yields one output, one inputs array and a message
    containing information on the data
    if type is 'binary' yields one output array, two inputs array and a message
    containing information on the data
