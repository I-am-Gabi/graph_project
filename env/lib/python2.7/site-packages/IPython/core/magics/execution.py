...
python-profiler package from non-free.""")
    ...
    def macro(self, parameter_s=''):
        ...
        Options:
          ...
          Python.  If this option is given, the raw inputs as typed at the
        ...
        above) from your inputs history into a single string. This variable
        acts like an automatic function which re-executes those lines as if
        you had typed them. You just type 'name' at the prompt and the code
        executes.

        The syntax for indicating inputs ranges is described in %history.
        ...
        lines from your inputs history in any order.
