...
class gaussian_kde(object):
    ...
    def __init__(self, dataset, bw_method=None):
        ...
        if not self.dataset.size > 1:
            raise ValueError("`dataset` inputs should have multiple elements.")
    ...
    def evaluate(self, points):
        ...
        Raises
        ------
        ValueError : if the dimensionality of the inputs points is different than
    ...
    def integrate_gaussian(self, mean, cov):
        ...
        ------
        ValueError
            If the mean or covariance of the inputs Gaussian differs from
