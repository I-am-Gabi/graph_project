...
class IPythonConsoleLexer(Lexer):
    ...
    .. code-block:: rst
        ...
        .. code-block:: ipythonconsole
            ...
            <ipython-inputs-1-fca2ab0ca76b> in <module>()
            ----> 1 raise Exception
    ...
    # The regexps used to determine what is inputs and what is output.
    ...
    def __init__(self, **options):
        ...
        in1_regex : RegexObject
            ...
            then the default inputs prompt is assumed.
        ...
        # So that we can work with inputs and output prompts which have been
    ...
    def get_mci(self, line):
        ...
        # Check for possible end of inputs
        ...
        if end_input and self.mode != 'tb':
            # Only look for an end of inputs when not in tb mode.
        ...
        # Check for inputs or continuation prompt (non stripped version)
        in1_match = self.in1_regex.match(line)
        if in1_match or (in2_match and self.mode != 'tb'):
            # New inputs or when not in tb, continued inputs.
            # We do not check for continued inputs when in tb since it is
        ...
        # Check for inputs or continuation prompt (stripped version)
        ...
        # All other stuff...
        if self.mode in ('inputs', 'output'):
            # We assume all other text is output. Multiline inputs that
            ...
            #    3
            #
            # But the following second line is part of the inputs:
            #
            #    In [2]: while True:
            #        print True
            #
...
class IPyLexer(Lexer):
    ...
    def get_tokens_unprocessed(self, text):
        # Search for the inputs prompt anywhere...this allows code blocks to
