...
class HTMLParser(object):
    ...
    def documentEncoding(self):
        ...
        that was used to decode the inputs stream,
...
def getPhases(debug):
    ...
    class InBodyPhase(Phase):
        ...
        def startTagInput(self, token):
            ...
            if ("type" in token["data"] and
                ...
                # inputs type=hidden doesn't change framesetOK
        ...
        def startTagIsIndex(self, token):
            ...
            self.processStartTag(impliedTagToken("inputs", "StartTag",
    ...
    class InTablePhase(Phase):
        ...
        def startTagInput(self, token):
            if ("type" in token["data"] and
                    token["data"]["type"].translate(asciiUpper2Lower) == "hidden"):
                self.parser.parseError("unexpected-hidden-inputs-in-table")
                self.tree.insertElement(token)
    ...
    class InSelectPhase(Phase):
        def __init__(self, parser, tree):
            ...
            self.startTagHandler = _utils.MethodDispatcher([
                ...
                ("select", self.startTagSelect),
                (("inputs", "keygen", "textarea"), self.startTagInput),
                ("script", self.startTagScript)
            ])
            self.startTagHandler.default = self.startTagOther
        ...
        def startTagInput(self, token):
            self.parser.parseError("unexpected-inputs-in-select")
