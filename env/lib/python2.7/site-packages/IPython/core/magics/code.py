...
ipython_input_pat = re.compile(r"<ipython\-inputs\-(\d+)-[a-z\d]+>$")
...
class CodeMagics(Magics):
    ...
    def save(self, parameter_s=''):
        ...
        Options:
          ...
          -r: use 'raw' inputs.  By default, the 'processed' history is used,
          so that magics are loaded in their transformed version to valid
          Python.  If this option is given, the raw inputs as typed as the
        ...
        This function uses the same syntax as %history for inputs ranges,
    ...
    def pastebin(self, parameter_s=''):
        ...
        The argument can be an inputs history range, a filename, or the name of a
        string or macro.
    ...
    def load(self, arg_s):
        ...
        Usage:\\
          ...
          where source can be a filename, URL, inputs history range, macro, or
        ...
        if not args:
            raise UsageError('Missing filename, URL, inputs history range, '
        ...
        if 's' in opts:
            try:
                ...
                # non python code
                error("Unable to parse the inputs as valid Python code")
                return
        ...
        if l > 200000 and 'y' not in opts:
            try:
                ...
                #asume yes if raw inputs not implemented
                ans = True
    ...
    def edit(self, parameter_s='',last_call=['','']):
        ...
        -r: use 'raw' inputs.  This option only applies to inputs taken from the
        user's history.  By default, the 'processed' history is used, so that
        magics are loaded in their transformed version to valid Python.  If
        this option is given, the raw inputs as typed as the command line is
        ...
        - The arguments are ranges of inputs history,  e.g. "7 ~1/4-6".
