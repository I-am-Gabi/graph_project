...
def _split_multiline_prompt(get_prompt_tokens):
    ...
    returns the tokens to be shown on the lines above the inputs; and another
    one with the tokens to be shown at the first line of the inputs.
    """
...
def create_prompt_layout(message='', lexer=None, is_password=False,
    ...
    :param get_continuation_tokens: An optional callable that takes a
        CommandLineInterface and width as inputs and returns a list of (Token,
    ...
    :param multiline: `bool` or :class:`~prompt_toolkit.filters.CLIFilter`.
        When True, prefer a layout that is more adapted for multiline inputs.
        Text after newlines is automatically indented, and search/arg inputs is
        shown below the inputs, instead of replacing the prompt.
    ...
    input_processors = [
        ConditionalProcessor(
            ...
            # inputs has the focus. (Note that this doesn't mean
    ...
    # Show the prompt before the inputs (using the DefaultPrompt processor.
    ...
    return HSplit([
        # The main inputs, with completion menus floating on top of it.
        FloatContainer(
            HSplit([
...
def create_prompt_application(
    ...
    customization is required. For more complex inputs, it is required to create
    a custom :class:`~Application` instance.)

    :param message: Text to be shown before the prompt.
    :param mulitiline: Allow multiline inputs. Pressing enter will insert a
                       newline. (This requires Meta+Enter to accept the inputs.)
    :param wrap_lines: `bool` or :class:`~prompt_toolkit.filters.CLIFilter`.
        When True (the default), automatically wrap long lines instead of
        scrolling horizontally.
    ...
    :param completer: :class:`~prompt_toolkit.completion.Completer` instance
        for inputs completion.
    :param reserve_space_for_menu: Space to be reserved for displaying the menu.
        (0 means that no space needs to be reserved.)
    :param auto_suggest: :class:`~prompt_toolkit.auto_suggest.AutoSuggest`
        instance for inputs suggestions.
    ...
    :param default: The default text to be shown in the inputs buffer. (This can
...
def prompt(message='', **kwargs):
    """
    Get inputs from the user and return it.
