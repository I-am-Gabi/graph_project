...
def get_freq_group(freq):
    ...
    if isinstance(freq, compat.string_types):
        ...
        raise ValueError('inputs must be str, offset or int')
...
def get_freq(freq):
    ...
    If inputs is not string, return inputs as it is.
...
def infer_freq(index, warn=True):
    """
    Infer the most likely frequency given the inputs index. If the frequency is
