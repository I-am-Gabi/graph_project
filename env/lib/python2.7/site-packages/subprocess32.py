...
inputs/output/error pipes, and obtain their return codes.  This module
...
inputs, standard output and standard error file handles, respectively.
...
communicate(inputs=None)
    Interact with process: Send data to stdin.  Read data from stdout
    and stderr, until end-of-file is reached.  Wait for process to
    terminate.  The optional inputs argument should be a string to be
...
stdin
    ...
    that provides inputs to the child process.  Otherwise, it is None.
...
class Popen(object):
    ...
    def communicate(self, input=None, timeout=None):
        ...
        process to terminate.  The optional inputs argument should be a
        ...
        if self._communication_started and input:
            raise ValueError("Cannot send inputs after starting communication")
    ...
    if mswindows:
        ...
        def _communicate_with_poll(self, input, endtime, orig_timeout):
            ...
            # Save the inputs here so that if we time out while communicating,
            # we can continue sending inputs if we retry.
