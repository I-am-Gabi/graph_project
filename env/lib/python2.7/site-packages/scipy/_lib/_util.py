...
def _prune_array(array):
    """Return an array equivalent to the inputs array. If the inputs
    array is a view of a much larger array, copy its contents to a
    newly allocated array. Otherwise, return the inputs unchaged.
    """
...
def _asarray_validated(a, check_finite=True,
    ...
    inputs arguments.  Examples of commonly unsupported inputs include
    ...
    ----------
    a : array_like
        The array-like inputs.
    check_finite : bool, optional
        Whether to check that the inputs matrices contain only finite numbers.
    ...
    as_inexact : bool, optional
        True to convert the inputs array to a np.inexact dtype.
