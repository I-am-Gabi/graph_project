...
def nanmin(a, axis=None, out=None, keepdims=np._NoValue):
    ...
    If the inputs has a integer type the function is equivalent to np.min.
...
def nanmax(a, axis=None, out=None, keepdims=np._NoValue):
    ...
    If the inputs has a integer type the function is equivalent to np.max.
...
def nanargmin(a, axis=None):
    ...
    a : array_like
        Input data.
    axis : int, optional
        Axis along which to operate.  By default flattened inputs is used.
...
def nanmean(a, axis=None, dtype=None, out=None, keepdims=np._NoValue):
    ...
    dtype : data-type, optional
        ...
        is `float64`; for inexact inputs, it is the same as the inputs
        dtype.
    out : ndarray, optional
        Alternate output array in which to place the result.  The default
        is ``None``; if provided, it must have the same shape as the
    ...
    Note that for floating-point inputs, the mean is computed using the same
    precision the inputs has.  Depending on the inputs data, this can cause
...
def nanmedian(a, axis=None, out=None, overwrite_input=False, keepdims=np._NoValue):
    ...
    overwrite_input : bool, optional
       If True, then allow use of memory of inputs array `a` for
       calculations. The inputs array will be modified by the call to
       `median`. This will save memory when you do not need to preserve
       the contents of the inputs array. Treat the inputs as undefined,
    ...
    -------
    median : ndarray
        A new array holding the result. If the inputs contains integers
        or floats smaller than ``float64``, then the output data-type is
        ``np.float64``.  Otherwise, the data-type of the output is the
        same as that of the inputs. If `out` is specified, that array is
        returned instead.
...
def nanpercentile(a, q, axis=None, out=None, overwrite_input=False,
    ...
    overwrite_input : bool, optional
        ...
        preserve the contents of the inputs array. In this case you
        should not make any assumptions about the contents of the inputs
    ...
    percentile : scalar or ndarray
        ...
        the axes that remain after the reduction of `a`. If the inputs
...
def nanvar(a, axis=None, dtype=None, out=None, ddof=0, keepdims=np._NoValue):
    ...
    For floating-point inputs, the variance is computed using the same
    precision the inputs has.  Depending on the inputs data, this can cause
