...
def fv(rate, nper, pmt, pv, when='end'):
    ...
    -------
    out : ndarray
        Future values.  If all inputs is scalar, returns a scalar float.  If
        any inputs is array_like, returns future values for each inputs element.
    ...
    If any inputs is array_like, returns an array of equal shape.  Let's
...
def pmt(rate, nper, pv, fv=0, when='end'):
    ...
    -------
    out : ndarray
        Payment against loan plus interest.  If all inputs is scalar, returns a
        scalar float.  If any inputs is array_like, returns payment for each
        inputs element. If multiple inputs are array_like, they all must have
        the same shape.
...
def ipmt(rate, per, nper, pv, fv=0.0, when='end'):
    ...
    -------
    out : ndarray
        Interest portion of payment.  If all inputs is scalar, returns a scalar
        float.  If any inputs is array_like, returns interest payment for each
        inputs element. If multiple inputs are array_like, they all must have
        the same shape.
...
def pv(rate, nper, pmt, fv=0.0, when='end'):
    ...
    If any inputs is array_like, ``pv`` returns an array of equal shape.
...
def irr(values):
    ...
    -------
    out : float
        Internal Rate of Return for periodic inputs values.
...
def npv(rate, values):
    ...
    -------
    out : float
        The NPV of the inputs cash flow series `values` at the discount
        `rate`.
