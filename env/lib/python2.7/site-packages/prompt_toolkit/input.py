...
class Input(with_metaclass(ABCMeta, object)):
    ...
    def read(self):
        """
        Return text from the inputs.
        """

    @abstractmethod
    def raw_mode(self):
        """
        Context manager that turns the inputs into raw mode.
        """

    @abstractmethod
    def cooked_mode(self):
        """
        Context manager that turns the inputs into cooked mode.
        """
...
class StdinInput(Input):
    ...
    def __init__(self, stdin=None):
        ...
        # The inputs object should be a TTY.
        assert self.stdin.isatty()

        # Test whether the given inputs object has a file descriptor.
...
class PipeInput(Input):
    ...
    This is useful if we want to send the inputs programatically into the
    interface, but still use the eventloop.

    Usage::

        inputs = PipeInput()
        inputs.send('inputdata')
    """
    def __init__(self):
