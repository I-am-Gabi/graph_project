...
class InputHookManager(object):
    ...
    def enable_gui(self, gui=None, app=None):
        ...
        Switch amongst GUI inputs hooks by name.

        This is a higher level method than :meth:`set_inputhook` - it uses the
        GUI name to look up a registered object which enables the inputs hook
        for that GUI.

        Parameters
        ----------
        gui : optional, string or None
          If None (or 'none'), clears inputs hook, otherwise it must be one
...
class InputHookBase(object):
    ...
    Base class for inputs hooks for specific toolkits.
