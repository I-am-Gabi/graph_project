...
class _fromnxfunction:
    ...
    provides support for a specific type of inputs should be used.
...
class _fromnxfunction_args(_fromnxfunction):
    ...
    arguments. The first non-array-like inputs marks the beginning of the
...
def average(a, axis=None, weights=None, returned=False):
    ...
    average, [sum_of_weights] : (tuple of) scalar or MaskedArray
        ...
        inputs data-type, otherwise. If returned, `sum_of_weights` is always
        `float64`.
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    overwrite_input : bool, optional
        ...
        False. Note that, if `overwrite_input` is True, and the inputs
        is not already an `ndarray`, an error will be raised.
    keepdims : bool, optional
        If this is set to True, the axes which are reduced are left
        in the result as dimensions with size one. With this option,
        the result will broadcast correctly against the inputs array.
    ...
    median : ndarray
        ...
        `float64`, or the inputs data-type, otherwise.
...
def _median(a, axis=None, out=None, overwrite_input=False):
    ...
    if asorted.ndim == 1:
        ...
        # if result is masked either the inputs contained enough
...
def cov(x, y=None, rowvar=True, bias=False, allow_masked=True, ddof=None):
    ...
    missing in either of the inputs arrays.
...
def vander(x, n=None):
    """
    Masked values in the inputs array result in rows of zeros.
