    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'highz1', 'if', 'initial', 'inout', 'inputs', 'integer', 'join', 'large',
            ...
            (words((
                ...
                'getpattern', 'history', 'incsave', 'inputs', 'itor', 'key', 'list', 'log',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'initial', 'inout', 'inputs', 'inside', 'instance', 'int', 'integer', 'interface',
