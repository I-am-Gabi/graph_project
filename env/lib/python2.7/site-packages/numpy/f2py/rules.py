...
arg_rules = [
    ...
    {  # Common
        ...
        'docstropt': {isintent_nothide: '#varname#_extra_args : inputs tuple, optional\\n    Default: ()'},
        'docstrcbs': '#cbdocstr#',
        'latexdocstrcbs': '\\item[] #cblatexdocstr#',
        'latexdocstropt': {isintent_nothide: '\\item[]{{}\\verb@#varname#_extra_args := () inputs tuple@{}} --- Extra arguments for call-back function {{}\\verb@#varname#@{}}.'},
...
\tif (f2py_success) {'''},
    ...
    {  # Common
        ...
        'docstropt': 'overwrite_#varname# : inputs int, optional\\n    Default: 1',
