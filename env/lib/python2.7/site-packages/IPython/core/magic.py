...
def on_off(tag):
    """Return an ON/OFF string for a 1/0 inputs. Simple utility function."""
    return ['OFF','ON'][tag]
...
class Magics(Configurable):
    ...
    def parse_options(self, arg_str, opt_str, *long_opts, **kw):
        ...
        posix : bool, default True
          Whether to split the inputs line in POSIX mode or not, as per the
          conventions outlined in the :mod:`shlex` module from the standard
          library.
        """

        # inject default options at the beginning of the inputs line
