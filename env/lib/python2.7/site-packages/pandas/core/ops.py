...
def add_special_arithmetic_methods(cls, arith_method=None,
    ...
    def _wrap_inplace_method(method):
        ...
        def f(self, other):
            ...
            # this makes sure that we are aligned like the inputs
...
axis : {0, 1, 'index', 'columns'}
    For Series inputs, axis to match Series index on
...
def _align_method_FRAME(left, right, axis):
    """ convert rhs to meet lhs dims if inputs is list, tuple or np.ndarray """
    ...
    def f(self, other, axis=None):
        ...
        if isinstance(other, self._constructor):
            return self._compare_constructor(other, na_op)
                                ...
                                ABCSeries)):
            raise Exception("inputs needs alignment for this object [%s]" %
                            self._constructor)
        else:
            return self._combine_const(other, na_op)
