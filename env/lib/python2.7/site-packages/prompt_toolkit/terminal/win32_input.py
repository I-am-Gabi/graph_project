...
class ConsoleInputReader(object):
    ...
    def read(self):
        ...
        # Get next batch of inputs event.
        windll.kernel32.ReadConsoleInputW(
            self.handle, pointer(input_records), max_count, pointer(read))

        # First, get all the keys from the inputs buffer, in order to determine
    ...
    def _get_keys(self, read, input_records):
        """
        Generator that yields `KeyPress` objects from the inputs records.
        """
