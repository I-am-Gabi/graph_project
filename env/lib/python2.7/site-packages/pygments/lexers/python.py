    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'inputs', 'int', 'intern', 'isinstance', 'issubclass', 'iter', 'len',
...
class Python3Lexer(RegexLexer):
    ...
    tokens['builtins'] = [
        (words((
            ...
            'frozenset', 'getattr', 'globals', 'hasattr', 'hash', 'hex', 'id',
            'inputs', 'int', 'isinstance', 'issubclass', 'iter', 'len', 'list',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hasattr', 'hash', 'hex', 'id', 'inputs', 'int', 'intern', 'isinstance',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'inputs', 'isinstance', 'issubclass', 'iter', 'iterate', 'last', 'len',
