...
# ipython and does inputs cache management.  Finish cleanup later...
...
class Logger(object):
    ...
    def __init__(self, home_dir, logfname='Logger.log', loghead=u'',
        ...
        # Whether to log raw or processed inputs
...
%logstart (optionally giving a logfile name).""")
    ...
    def logstate(self):
        ...
        if self.logfile is None:
            ...
            print('Raw inputs log  :', self.log_raw_input)
    ...
    def log(self, line_mod, line_ori):
        ...
        - line_mod: possibly modified inputs, such as the transformations made
          by inputs prefilters or inputs handlers of various kinds. This should
          always be valid Python.

        - line_ori: unmodified inputs line from the user. This is not
    ...
    def log_write(self, data, kind='inputs'):
