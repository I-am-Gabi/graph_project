...
class Rectangle(object):
    ...
    def min_distance_point(self, x, p=2.):
        """
        Return the minimum distance between inputs and points in the hyperrectangle.
    ...
    def max_distance_point(self, x, p=2.):
        """
        Return the maximum distance between inputs and points in the hyperrectangle.
